...
class UserManager(BaseUserManager):
    ...
    def create_user(self, username, email=None, password=None, **extra_fields):
        return self._create_user(username, email, password, self.model.LEVEL_USER,
            **extra_fields)
 
    def create_superuser(self, username, email, password, **extra_fields):
        user=self._create_user(username, email, password, self.model.LEVEL_ADMIN,
            **extra_fields)
        user.save(using=self._db)
        return user
...
class Trip(models.Model):
    ...
    def save(self):
        ...
        Transaction.objects.create(user=self.user,
            amount=self.price, trip=self, type=Transaction.TYPE_TRIP)
